...
val releaseApiBaseUrl = providers.gradleProperty("markstash.apiBaseUrl")
    .orElse("https://api.markstash.invalid/")
    .get()
    ...
    buildTypes {
        debug {
            ...
            buildConfigField(
                "String",
                "API_BASE_URL",
                "http://10.0.2.2:5080/".asBuildConfigLiteral(),
            )
            manifestPlaceholders["usesCleartextTraffic"] = "true"
        }
        release {
            buildConfigField("String", "API_BASE_URL", releaseApiBaseUrl.asBuildConfigLiteral())
